...
export const CRT_FRAGMENT_SHADER =
  ...
  "  col *= grille;\n"+
  "  col *= 1.34;\n"+
  "  float bar = fract(uv.x*0.5 - uTime*0.05*uMotion);\n"+
  ...
  "  col += sheen*0.030*vec3(1.0,0.55,0.78);\n"+
  ...
  "  vec3 room = vec3(0.03,0.012,0.015) + vec3(spill*0.6,spill*0.2,spill*0.25);\n"+
  "  col = mix(room, col, inside);\n"+
  "  col = max(col, vec3(0.010,0.004,0.006));\n"+
