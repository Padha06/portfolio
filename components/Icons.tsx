...
export const SmartphoneIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const PenToolIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const StarIcon: React.FC<IconProps & { fill?: boolean }> = ({ size = 24, className = '', fill = false }) => (
...
export const QuoteIcon: React.FC<IconProps> = ({ size = 24, className = '' }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M9.13456 9H5.00001C5.00001 6.23858 7.23858 4 10 4V6C8.34315 6 7 7.34315 7 9H10C11.1046 9 12 9.89543 12 11V16C12 17.1046 11.1046 18 10 18H8.00001C6.89544 18 6.00001 17.1046 6.00001 16V14H4.00001C4.00001 16.7614 5.73858 19 8.00001 19V21C4.68629 21 2 18.3137 2 15V9H2.00001L2.00001 7H2.00001C2.00001 4.23858 4.23858 2 7.00001 2V4C5.34316 4 4.00001 5.34315 4.00001 7H7.00001C8.10458 7 9.00001 7.89543 9.00001 9V9H9.13456Z"/>
    <path d="M20.1346 9H16C16 6.23858 18.2386 4 21 4V6C19.3432 6 18 7.34315 18 9H21C22.1046 9 23 9.89543 23 11V16C23 17.1046 22.1046 18 21 18H19C17.8954 18 17 17.1046 17 16V14H15C15 16.7614 16.7386 19 19 19V21C15.6863 21 13 18.3137 13 15V9H13L13 7H13C13 4.23858 15.2386 2 18 2V4C16.3432 4 15 5.34315 15 7H18C19.1046 7 20 7.89543 20 9V9H20.1346Z"/>
  </svg>
)
